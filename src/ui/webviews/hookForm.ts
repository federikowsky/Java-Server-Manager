import type { HookCommandConfig, HookConfig, HookEvent, HookKind, HookPhase } from '@core/types';
import type { FieldError } from './protocol';
...
export const HOOK_EVENT_OPTIONS: { value: HookEvent; label: string }[] = [
  { value: 'lifecycle.start', label: 'Lifecycle Start' },
  { value: 'lifecycle.stop', label: 'Lifecycle Stop' },
  { value: 'lifecycle.restart', label: 'Lifecycle Restart' },
